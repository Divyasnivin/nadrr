...
ALIVE_NAME = getenv("ALIVE_NAME", "خخ")
AMR_NAME = getenv("AMR_NAME", "خخ")
BOT_USERNAME = getenv("BOT_USERNAME", "xfjbot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "fal♫")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Divyasnivin/nadrr")
